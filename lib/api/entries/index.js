...
function configure (app, wares, ctx, env) {
  ...
  function insert_entries (req, res, next) {
    ...
    console.log('-----------------------------------------------------------------------');
    console.log('-----------------------------------------------------------------------');
    console.log('API: ---> Nouvelle glycémie reçu ??????????????');
    console.log('-----------------------------------------------------------------------');
    console.log('-----------------------------------------------------------------------');
    ...
    console.log('-----------------------------------------------------------------------');
    console.log('-----------------------------------------------------------------------');
    console.log(Number(result[0].sgv/18).toFixed(1));
    console.log(Number(result[1].sgv/18).toFixed(1));
    console.log(Number(result[2].sgv/18).toFixed(1));
    console.log(Number(result[3].sgv/18).toFixed(1));
    console.log(Number(result[4].sgv/18).toFixed(1));
    console.log(Number(result[5].sgv/18).toFixed(1));
    console.log(Number(result[6].sgv/18).toFixed(1));
    console.log(Number(result[7].sgv/18).toFixed(1));
    console.log(Number(result[8].sgv/18).toFixed(1));
    console.log(Number(result[9].sgv/18).toFixed(1));


    var glyc = Number(result[0].sgv/18).toFixed(1);
    var sysTime = result[0].sysTime;
    var d = new Date(sysTime);
    ...
    //var offset = AA_TIME_ZONE_OFFSET;   //-4 pourEST .... Moncton, NB
    var offset = 4;
    ...
    var timeStamp = d.toLocaleDateString('fr-FR', options);
    
    console.log(hr+":"+min);
    console.log(timeStamp);


    var dir = result[0].direction;
    var messageToSend = false;
    var m ="";
    var mob = env.cellNumDay;
    if ((dir==='DoubleUp') || (dir==='DoubleDown') ) 
      { messageToSend = true;};
    if ((dir==='SingleDown') && (glyc <= 7)  )       
      { messageToSend = true;};
    if ((dir==='FortyFiveDown') && (glyc <= 6)  )    
      { messageToSend = true;};
    if (glyc <= 4)                                   
      { messageToSend = true;};
    if ((d.getHours >= 22) || (d.getHours <= 6)) {
      mob = env.cellNumNight;
    };

/*
    console.log('+++++++++++++++++++++++++++++++++++++++++++++++++');
    console.log(env.cellNumDay);
    console.log(env.cellNumDayOffset);
    console.log(env.cellNumNight);
    console.log(env.cellNumNightOffset);
    console.log('+++++++++++++++++++++++++++++++++++++++++++++++++');
*/
...
//    if (messageToSend) { 
    if (false) { 
      var accountSid = env.twilioSsid;
      var authToken =  env.twilioToken;
      const client = require('twilio')(accountSid, authToken);
      m = timeStamp + "\n";
      m = m + hr + ":" + min + "\n"; 
      m = m + "Glycémie  : " + glyc + "\n";
      m = m + "Direction : " + result[0].direction + "\n";
