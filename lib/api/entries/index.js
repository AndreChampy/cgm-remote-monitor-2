...
function configure (app, wares, ctx, env) {
  ...
  function format_entries (req, res) {
    ...
    function formatWithSeparator (data, separator) {
      console.log('-----------------------------------------------------------------------');
      console.log('-----------------------------------------------------------------------');
      console.log('function formatWithSeparator (data, separator) { ----------------------');
  ...
  function insert_entries (req, res, next) {
    console.log('-----------------------------------------------------------------------');
    console.log('-----------------------------------------------------------------------');
    console.log('function insert_entries (req, res, next) {   --------------------------');
...
//    console.log('-----------------------------------------------------------------------');
    ...
    env.lastReadingsReceived.shift();
    env.lastReadingsReceived.push(glyc);
    var l5rdgs = env.lastReadingsReceived;
    console.log('Last 5 readings: --------------> ' + l5rdgs);
    if (l5rdgs[0]==l5rdgs[1] && l5rdgs[1]==l5rdgs[2] && l5rdgs[2]==l5rdgs[3] && l5rdgs[3]==l5rdgs[4]) {
      messageToSend = true;
      m = m + "Check CGM device kit - Last 5 readings where equal ! /n";
    };
