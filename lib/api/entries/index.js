...
*/
    ...
    var m ="";
    var mob = env.AA_CELL_NUM;
    if ((dir==='DoubleUp') || (dir==='DoubleDown') ) { messageToSend = true;};
    if ((dir==='SingleDown') && (glyc <= 7)  )       { messageToSend = true;};
    if ((dir==='FortyFiveDown') && (glyc <= 6)  )    { messageToSend = true;};
    if (glyc <= 4)                                   { messageToSend = true;};

    if ((d.getHours >= 22) || (d.getHours <= 6)) {
      mob = env.AA_CELL_NUM_NIGHT;
    };
...
//    if (messageToSend) { 
      ...
      const accountSid = 'AC451f7e6faf1a2dc93b0c657e139e9d50';
      const authToken = '1df927b8c7de88c04826f6fb1b93f6c9';
